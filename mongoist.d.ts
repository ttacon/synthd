declare module "mongoist" {
  ...
  type abortTxnNull = () => Promise<any>;
  type abortTxnCallback = (callback: ((arg0: Error | null, reply?: null) => any)) => void;
  type commitTxn = () => Promise<any>;
  type commitTxnCallback = (callback: ((arg0: Error | null, reply?: null) => any)) => void;
  type endSession = () => void;
  type endSessionCallback = (callback: ((arg0: Error | null, reply?: null) => any)) => void;
  type endSessionMixed = (
      options: {
        [K in string]: any;
      } | null,
  ...
  interface ClientSession {
    id: any;
    abortTransaction: (abortTxnNull | abortTxnCallback);
    advanceOperationTime: ((timestamp: Timestamp) => void);
    commitTransaction: (commitTxn | commitTxnCallback);
    endSession: (endSession | endSessionCallback | endSessionMixed);
  ...
  export class Cursor<Doc> {
    constructor(cursorFactory: (() => Promise<InternalCursor>));
    ...
    map(fn: ((doc: Doc) => any)): Promise<any[]>;
  ...
  export class Collection {
    constructor(db: Database_, name: string);
    name: string;
    ...
    insertMany(docs: Doc[], options?: InsertOptions): Promise<Map<Doc[], AddObjectIDField>>;
    ...
    drop(): Promise<any>;
    stats(): Promise<any>;
    mapReduce(map: MapParam, reduce: ReduceParam<any>, options: MapReduceOptions<any>): Promise<any>;
  ...
  class Database_  {
    constructor(connectionString: MaybePromise<string>, options?: ConnectionOptions);
    constructor(database: MaybePromise<Database_ | DatabaseWithProxy | MongoJSDuck>);
  ...
  export class ObjectID {
    constructor(value?: string | number | ObjectID | null);
